...
// FIXME: Use in Missile and Tank lastMoved, plus endTime in GameState.
/**
 * Implementations of this interface provide consistent reads and updates of a long value. That is,
 ...
 * @author dsquirre
 */
public interface ConsistentLong {
    long get();
    void set(long x);
}
